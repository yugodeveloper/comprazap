...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      increment_campaign_views: { Args: { row_id: string }; Returns: undefined }
      save_campaign_products: {
        Args: { new_variations: Json; target_campaign_id: string }
        Returns: undefined
      }
    }
    Enums: {
